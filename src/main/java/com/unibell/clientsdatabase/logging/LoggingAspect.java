package com.unibell.clientsdatabase.logging;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.unibell.clientsdatabase.controller.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.unibell.clientsdatabase.controller.*.*(..))",
            returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.unibell.clientsdatabase.controller.*.*(..))",
            throwing = "exception")
